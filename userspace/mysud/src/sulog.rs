...
use crate::{defs, module_config, mysucalls, utils};

const MYSU_EVENT_QUEUE_TYPE_DROPPED: u16 = u16::MAX;
const MYSU_EVENT_RECORD_FLAG_INTERNAL: u16 = 1;
...
pub const SULOG_CONFIG_MODULE_ID: &str = "internal.mysud.sulogd";
...
fn format_record_line(header: EventRecordHeader, payload: &[u8]) -> Result<String> {
    if header.record_type == MYSU_EVENT_QUEUE_TYPE_DROPPED {
        ensure!(
            header.flags & MYSU_EVENT_RECORD_FLAG_INTERNAL != 0,
