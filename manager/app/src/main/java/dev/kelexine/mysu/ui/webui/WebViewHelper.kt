package dev.kelexine.mysu.ui.webui
...
import dev.kelexine.mysu.ui.util.AppIconCache
import dev.kelexine.mysu.ui.util.createRootShell
import dev.kelexine.mysu.ui.util.withMainUserUid
        ...
        withContext(Dispatchers.Main) {
            ...
            webView.webViewClient = object : WebViewClient() {
                override fun shouldInterceptRequest(view: WebView, request: WebResourceRequest): WebResourceResponse? {
                    val url = request.url
                    if (url.scheme.equals("mysu", ignoreCase = true) && url.host.equals("icon", ignoreCase = true)) {
            ...
            webView.addJavascriptInterface(webviewInterface, "mysu")
