...
import dev.kelexine.mysu.ui.MainActivity
...
class DownloadService : Service() {
    ...
    companion object {
        ...
        const val ACTION_DOWNLOAD = "dev.kelexine.mysu.action.DOWNLOAD"
        const val ACTION_CANCEL = "dev.kelexine.mysu.action.CANCEL_DOWNLOAD"
        const val ACTION_DISMISS_DOWNLOAD = "dev.kelexine.mysu.action.DISMISS_DOWNLOAD"
        const val ACTION_INSTALL_MODULE = "dev.kelexine.mysu.action.INSTALL_MODULE"
    ...
    private fun startDownload(id: Int, url: String, fileName: String) {
        val job = serviceScope.launch {
            ...
            try {
                mysuApp.okhttpClient.newCall(Request.Builder().url(url).build()).execute()
                    .use { resp ->
