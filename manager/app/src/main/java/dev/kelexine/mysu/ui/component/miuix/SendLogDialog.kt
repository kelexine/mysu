package dev.kelexine.mysu.ui.component.miuix
...
import dev.kelexine.mysu.ui.component.dialog.LoadingDialogHandle
import dev.kelexine.mysu.ui.util.getBugreportFile
        ...
        content = {
            ...
            ArrowPreference(
                ...
                onClick = {
                    ...
                    exportBugreportLauncher.launch("MySU_bugreport_${current}.tar.gz")
                    onDismissRequest()
                },
